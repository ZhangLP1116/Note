...
https://leetcode.cn/problems/scramble-string/solutions/724718/rao-luan-zi-fu-chuan-by-leetcode-solutio-8r9t/
...
class Solution {
    ...
    public boolean dfs(int i1, int i2, int length) {
        if (memo[i1][i2][length] != 0) {
            return memo[i1][i2][length] == 1;// 记忆结果返回
        }
